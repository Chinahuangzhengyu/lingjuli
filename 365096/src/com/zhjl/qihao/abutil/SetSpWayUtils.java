...
import static com.zhjl.qihao.abutil.NewStatusBarUtils.getStatusBarHeight;

/**
 * 作者： 黄郑宇
 * 时间： 2018/9/5
 * 类作用：屏幕适配（用今日头条的方式通过改变系统字体和像素密度）
 */
public class SetSpWayUtils {
    private static final int WIDTH = 1;
    private static final int HEIGHT = 2;
    private static final float DEFAULT_WIDTH = 375f; //默认宽度
    private static final float DEFAULT_HEIGHT = 812f; //默认高度
