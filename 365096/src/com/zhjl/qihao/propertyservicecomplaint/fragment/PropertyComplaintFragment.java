...
import com.zhjl.qihao.activity.NewPhotoMultipleUploadActivity;
...
public class PropertyComplaintFragment extends VolleyBaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_property_complaint, container, false);
        }
        ...
        rgComplaintType.setOnCheckedChangeListener((group, checkedId) -> {
...
//		dialog.dismiss();
    ...
    @OnClick({R.id.rl_complaint_name, R.id.btn_submit})
