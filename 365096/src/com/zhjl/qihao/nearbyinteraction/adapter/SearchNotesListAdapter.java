...
public class SearchNotesListAdapter extends RecyclerView.Adapter {

    private VolleyBaseActivity mContext;
    private List<SearchNotesBean.DataBean> data;
    //1张图片布局
    ...
    public SearchNotesListAdapter(VolleyBaseActivity mContext, List<SearchNotesBean.DataBean> data) {
...
//    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if (i == ONE_PHOTO_VIEW) {
            ...
            return new SearchNotesListAdapter.OneViewHolder(view);
        } else {
            View view = LayoutInflater.from(mContext).inflate(R.layout.nearby_list_more, viewGroup, false);
            return new SearchNotesListAdapter.MoreViewHolder(view);
        }
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int i) {
        if (holder instanceof SearchNotesListAdapter.OneViewHolder) {
            SearchNotesListAdapter.OneViewHolder oneHolder = (SearchNotesListAdapter.OneViewHolder) holder;
...
//            }
            ...
            SearchNotesListAdapter.MoreViewHolder moreHolder = (SearchNotesListAdapter.MoreViewHolder) holder;
            if (data.get(i).getCreateUser().getAvatar() != null) {
...
//            });
            ...
            if (data.get(i).getForumPictureList().size() == 0) {
                ...
                moreHolder.gvImg.setAdapter(new SearchNotesListAdapter.PhotoAdapter(data.get(i).getForumPictureList()));
            }
...
//            }
    ...
    public void addData(List<SearchNotesBean.DataBean> data) {
        this.data = data;
        notifyDataSetChanged();
    }
    ...
    class PhotoAdapter extends BaseAdapter {
        private List<SearchNotesBean.DataBean.ForumPictureListBean> forumPictureList;

        public PhotoAdapter(List<SearchNotesBean.DataBean.ForumPictureListBean> forumPictureList) {
