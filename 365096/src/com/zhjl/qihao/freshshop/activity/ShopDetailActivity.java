...
public class ShopDetailActivity extends VolleyBaseActivity {
...
//    TextView tvAddress;
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(ShopDetailActivity activity) {
            mActivity = new WeakReference<ShopDetailActivity>(activity);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llBottom.setOnClickListener(this);//设置点击事件防止事件穿透
...
//        webSettings.setCacheMode(WebSettings.LOAD_NO_CACHE);
        ...
        activityRequestPhpData(call, new RequestResult<Object>() {
            ...
            public void success(Object result, String message) throws Exception {
                ...
                if (object.optBoolean("status")) {
                    ...
                    if (shopDetailBean.getProduct() == null || shopDetailBean.getProduct().getStock().equals("") || Double.parseDouble(shopDetailBean.getProduct().getStock()) == 0) {
                        tvStock.setText("已售罄");
                        tvStock.setTextColor(ContextCompat.getColor(mContext, R.color.color_f80000));
                        tvNowBuy.setText("商品已售罄");
                        tvNowBuy.setTextColor(Color.parseColor("#7BCD88"));
                        tvNowBuy.setEnabled(false);
                        tvNowBuy.setBackground(ContextCompat.getDrawable(mContext, R.drawable.circle_green_22));
                        tvAddCar.setVisibility(View.GONE);
                    } else {
                        tvStock.setText("库存" + shopDetailBean.getProduct().getStock());
                        tvStock.setTextColor(ContextCompat.getColor(mContext, R.color.ff999999));
                    }
                    ...
                    if (midImages.size() == 0) {       //没有图片也显示默认图
                        ImageView view = new ImageView(mContext);
                        PictureHelper.setImageView(mContext, "", view, R.drawable.img_err);
                        view.setScaleType(ImageView.ScaleType.FIT_XY);
                        listImgs.add(view);
                    }
                    ...
                    Utils.phpIsLogin(ShopDetailActivity.this, object.optInt("type"), object.optString("message"));
                }
                isFinish++;
                isFinish();
            }
    ...
    class ShopEvaluateAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
                PictureHelper.setHeadImageView(mContext, comments.get(position).getUser_picture(), holder.imgEvaluate, R.drawable.ic_head);
...
//            container.removeView(listImgs.get(position));
    ...
    @OnClick({R.id.img_back, R.id.img_shop_more, R.id.rl_shop_car, R.id.tv_shop_evaluate, R.id.tv_call_person, R.id.tv_collection, R.id.tv_add_car, R.id.tv_now_buy})
...
//                Utils.callPerson(this, "是否拨打电话0855-8552588", "0855-8552588");
    ...
    private void initShopAttrsPop(boolean isBuyCar) {
        ...
        fragment.setOnSureClickListener((isBuyCar1, moreTypeId) -> initShopSum());
    }
