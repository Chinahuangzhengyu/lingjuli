...
public class AnyRoundImageView extends AppCompatImageView {
    ...
    public AnyRoundImageView(Context context) {
        this(context, null);
    }

    public AnyRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public AnyRoundImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        matrix = new Matrix();
        bitmapPaint = new Paint();
        bitmapPaint.setAntiAlias(true);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.AnyRoundImageView);
        type = array.getInt(R.styleable.AnyRoundImageView_type, TYPE_CIRCLE);
        scaleType = array.getInt(R.styleable.AnyRoundImageView_scale, SCALE_TYPE_FIT);

        corners_top_left = array.getBoolean(R.styleable.AnyRoundImageView_top_left, true);
        corners_top_right = array.getBoolean(R.styleable.AnyRoundImageView_top_right, true);
        corners_bottom_left = array.getBoolean(R.styleable.AnyRoundImageView_bottom_left, true);
        corners_bottom_right = array.getBoolean(R.styleable.AnyRoundImageView_bottom_right, true);

        borderRadius = array.getDimensionPixelSize(R.styleable.AnyRoundImageView_borderRadius,
    ...
    public void setCorners_top_left(boolean corners_top_left) {
        this.corners_top_left = corners_top_left;
    }

    public void setCorners_top_right(boolean corners_top_right) {
        this.corners_top_right = corners_top_right;
    }

    public void setCorners_bottom_left(boolean corners_bottom_left) {
        this.corners_bottom_left = corners_bottom_left;
    }

    public void setCorners_bottom_right(boolean corners_bottom_right) {
        this.corners_bottom_right = corners_bottom_right;
    }
