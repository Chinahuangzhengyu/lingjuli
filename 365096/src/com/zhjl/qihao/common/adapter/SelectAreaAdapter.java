...
public class SelectAreaAdapter extends BaseAdapter {
	...
	public SelectAreaAdapter(JSONArray areaList,Context context,String curArea) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mViewHolder.tv_conent.setText(areaObject.optString("name"));
		mViewHolder.tv_conent.setTag(areaObject.optString("id"));
		return convertView;
	}
