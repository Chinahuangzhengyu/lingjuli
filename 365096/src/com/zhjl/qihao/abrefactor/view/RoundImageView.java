...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public void setRoundImg(Context context,int round){
        this.mBorderRadius = Utils.dip2px(context,round);
    }
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderRadius = Utils.dip2px(context,array.getInteger(R.styleable.RoundImageView_round,0));
        array.recycle();  //注意回收
        mMatrix = new Matrix();
        mPaint = new Paint();
