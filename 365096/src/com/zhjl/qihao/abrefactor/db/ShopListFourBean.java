...
@Entity
public class ShopListFourBean implements Parcelable {
    @Id
    private String id;
    @Unique
    private String pic;
    ...
    private String url;
    private int star;
    @Generated(hash = 1231596976)
    public ShopListFourBean(String id, String pic, String name, String subhead,
    ...
    @Generated(hash = 1718758698)
    public ShopListFourBean() {
    }
    public String getId() {
        return this.id;
    }
    ...
    protected ShopListFourBean(Parcel in) {
    ...
    public static final Creator<ShopListFourBean> CREATOR = new Creator<ShopListFourBean>() {
        @Override
        public ShopListFourBean createFromParcel(Parcel source) {
            return new ShopListFourBean(source);
        }

        @Override
        public ShopListFourBean[] newArray(int size) {
            return new ShopListFourBean[size];
        }
    };
}
