...
@Entity
public class ShopListTwoBean implements Parcelable {
    @Id
    private String id;
    private String pic;
    private String name;
    ...
    private String url;
    private int star;
    @Generated(hash = 456657590)
    public ShopListTwoBean(String id, String pic, String name, String subhead,
    ...
    @Generated(hash = 1003265689)
    public ShopListTwoBean() {
    }
    public String getId() {
        return this.id;
    }
    ...
    protected ShopListTwoBean(Parcel in) {
    ...
    public static final Creator<ShopListTwoBean> CREATOR = new Creator<ShopListTwoBean>() {
        @Override
        public ShopListTwoBean createFromParcel(Parcel source) {
            return new ShopListTwoBean(source);
        }

        @Override
        public ShopListTwoBean[] newArray(int size) {
            return new ShopListTwoBean[size];
        }
    };
}
