...
public class AllOrderFragment extends VolleyBaseFragment {
    ...
    public static AllOrderFragment getInstance(int status) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        allOrderAdapter.setGetOrderStatus(new AllOrderAdapter.getOrderStatus() {
            ...
            public void getStatus(int type) {
                if (type == 6) {
                    if (allOrderAdapter.orderList.size() == 0) {
