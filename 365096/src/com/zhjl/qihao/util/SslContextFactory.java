...
public class SslContextFactory {
    ...
    public static String TRUST_CA_PWD = "CK5lp7Ug";
    public static String SELF_CERT_PWD = "CK5lp7Ug";
    /**
     * 单项认证
     */
    ...
    public static SSLSocketFactory getSSLSocketFactoryForTwoWay() {
        try {
            InputStream certificate = ZHJLApplication.getContext().getResources().openRawResource(R.raw.app);
            ...
            clientKeyStore.load(ZHJLApplication.getContext().getResources().openRawResource(R.raw.app), TRUST_CA_PWD.toCharArray());
