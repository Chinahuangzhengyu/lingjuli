...
/** 
 * DAO for table "SHOP_LIST_FOUR_BEAN".
*/
public class ShopListFourBeanDao extends AbstractDao<ShopListFourBean, String> {

    public static final String TABLENAME = "SHOP_LIST_FOUR_BEAN";

    /**
     * Properties of entity ShopListFourBean.<br/>
    ...
    public ShopListFourBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ShopListFourBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHOP_LIST_FOUR_BEAN\" (" + //
                "\"ID\" TEXT PRIMARY KEY NOT NULL ," + // 0: id
                "\"PIC\" TEXT UNIQUE ," + // 1: pic
                "\"NAME\" TEXT," + // 2: name
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SHOP_LIST_FOUR_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ShopListFourBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ShopListFourBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ShopListFourBean readEntity(Cursor cursor, int offset) {
        ShopListFourBean entity = new ShopListFourBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ShopListFourBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(ShopListFourBean entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(ShopListFourBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ShopListFourBean entity) {
