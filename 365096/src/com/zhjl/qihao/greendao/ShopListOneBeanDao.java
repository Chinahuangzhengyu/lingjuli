...
/** 
 * DAO for table "SHOP_LIST_ONE_BEAN".
*/
public class ShopListOneBeanDao extends AbstractDao<ShopListOneBean, String> {

    public static final String TABLENAME = "SHOP_LIST_ONE_BEAN";

    /**
     * Properties of entity ShopListOneBean.<br/>
    ...
    public ShopListOneBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ShopListOneBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHOP_LIST_ONE_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SHOP_LIST_ONE_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ShopListOneBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ShopListOneBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ShopListOneBean readEntity(Cursor cursor, int offset) {
        ShopListOneBean entity = new ShopListOneBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ShopListOneBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(ShopListOneBean entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(ShopListOneBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ShopListOneBean entity) {
