...
public class ScrollViewContainer extends RelativeLayout {
            ...
            if (mMoveLen != 0) {
                if (state == AUTO_UP) {
                    ...
                    if (mMoveLen <= -mViewHeight) {
                        ...
                        state = DONE;
                        mCurrentViewIndex = 1;
                        if(onPageChange!=null)onPageChange.onPageChange(mCurrentViewIndex);
                    }
    ...
    public IPageChange getOnPageChange() {
        return onPageChange;
    }

    public void setOnPageChange(IPageChange onPageChange) {
...
//			}
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isMeasured) {
            ...
            if(mViewHeight == 0)mViewHeight = getMeasuredHeight();
