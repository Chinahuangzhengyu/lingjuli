...
public class WizardGridView  extends GridView {



	public WizardGridView(Context context,AttributeSet attrs) {
        super(context, attrs);
    }
	public WizardGridView (Context context) {
        super(context);
    }
	public WizardGridView (Context context, AttributeSet attrs, int defStyle) {
