...
public class NumberProgressBar extends View {
	...
	public NumberProgressBar(Context context, AttributeSet attrs,
		...
		setMax(attributes.getInt(R.styleable.NumberProgressBar_max, 60));
		//
		attributes.recycle();
	...
	private void calculateDrawRectF() {
		...
		mCurrentDrawText = String.format("%d", getProgress() * 60 / getMax());
		if (mCurrentDrawText.equals("60")) {
			mCurrentDrawText = "01:00";
		} else {
			if (Integer.parseInt(mCurrentDrawText) < 10) {
				mCurrentDrawText = "00:0" + mCurrentDrawText;
			} else {
				mCurrentDrawText = "00:" + mCurrentDrawText;
			}
		}
