...
public class IOTCAPIs {
	...
	* Please see IOTCConnectionMode for possible modes. */
	...
	public native static int  IOTC_Connect_ByName(String DeviceName, String DevicePWD);
	public native static int  IOTC_Connect_ByName2(String DeviceName, String DevicePWD, String AesKey, int mode); // mode-> 0: equal IOTC_Listen(), 1: only accept secure connection, 2: accept non-secure and secure then use IOTC_Session_Check() to know which mode
	...
	public native static int XD(String UID, long mg);
	public native static St_LanSearchResp[] SA(int[] num, long mg);
	public native static long RT(int SID, long mg);
	public native static short AT(int SID, long mg);
	public native static float PL(int SID, int ChID, long mg);
