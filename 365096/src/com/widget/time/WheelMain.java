...
public class WheelMain {
        ...
        OnWheelChangedListener wheelListener_month = new OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                ...
                if (wv_year.getCurrentItem() == 0) {
                    month_num = newValue + 1 + START_MONTH;
                } else {
    ...
    public String getTime() {
        ...
        if (!hasSelectTime) {
            ...
            int monthstr = (wv_month.getCurrentItem() + 1) + START_MONTH;
            if (monthstr < 10) {
                sb.append("-").append("0"+monthstr);
            }else {
                sb.append("-").append(monthstr);
            }
            int daystr = (wv_month.getCurrentItem() + 1) + START_MONTH;
            if (monthstr < 10) {
                sb.append("-").append("0"+monthstr);
            }else {
                sb.append("-").append(monthstr);
            }*/
            // sb.append(String.format("02d",wv_day.getCurrentItem() + 1));
            int year = 0;
            ...
            sb.append(year + "").append(String.format("%02d", month)).append(String.format("%02d", day));
            //.append("-").append((wv_day.getCurrentItem() + 1));
            //sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-").append((wv_month.getCurrentItem() + 1)+START_MONTH).append("-").append((wv_day.getCurrentItem() + 1));
        } else {
            int year = 0;
            year = wv_year.getCurrentItem() + START_YEAR;
            int month = 0;
